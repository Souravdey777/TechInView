...
const steps: Step[] = [
  ...
  },
  {
    ...
    description:
      "Conduct a full 45-minute mock interview with Tia or a company-specific persona. Discuss your approach verbally, write code in the editor, and answer follow-up questions.",
