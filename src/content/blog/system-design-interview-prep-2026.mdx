...
seoTitle: "System Design Interview Prep: What to Study First"
...
**Honest product note:** TechInView runs **voice DSA rounds** with live coding and **[stack-depth Q&A rounds](/blog/technical-qa-interview-round-prep)**; a dedicated system design runtime is not shipped yet. System design is **adjacent prep** for many full loops; use this article to sequence study, then pair **coding mocks** (e.g. [communication](/blog/coding-interview-communication), [complexity](/blog/time-complexity-cheat-sheet)) for the rounds where you type under time pressure.
