...
Yes. This round is entirely verbal, so it punishes written-only prep even harder than coding rounds do — see [thinking out loud](/blog/coding-interview-communication).
